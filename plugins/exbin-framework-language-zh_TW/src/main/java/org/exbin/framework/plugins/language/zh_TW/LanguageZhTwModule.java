        ...
        try {
            application.registerLanguagePlugin(new LanguageProvider() {
                ...
                public Optional<ImageIcon> getFlag() {
                    return Optional.of(new ImageIcon(getClass().getResource("/resources/images/flags/tw.png")));
                }
            });
        } catch (Throwable ex) {
            application.registerLanguagePlugin(Locale.TAIWAN, getClass().getClassLoader());
        }
    }
