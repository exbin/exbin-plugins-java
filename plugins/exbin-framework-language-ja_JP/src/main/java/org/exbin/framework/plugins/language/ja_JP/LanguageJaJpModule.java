 ...
 */
package org.exbin.framework.plugins.language.ja_JP;
 ...
 */
public class LanguageJaJpModule implements XBApplicationModule {
    ...
    public void init(XBModuleHandler moduleHandler) {
        ...
        try {
            ...
            application.registerLanguagePlugin(new Locale("ja", "JP"), getClass().getClassLoader());
        }
    }
