 ...
 */
package org.exbin.jaguif.plugins.iconset.test;
...
public class IconSetTestModule implements PluginModule {
    ...
    public void register() {
        ...
        languageModule.registerIconSetProvider(new IconSetProvider() {
            ...
            @Override
            public String getId() {
                return "org.exbin.jaguif.plugins.iconset.test";
            }
            ...
            public String getIconKey(String key) {
                if (keys == null) {
                    ...
                    InputStream stream = getClass().getResourceAsStream("/org/exbin/jaguif/plugins/iconset/test/iconset.properties");
                    try {
